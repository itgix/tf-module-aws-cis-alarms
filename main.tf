locals {
  all_controls = {
    ...
    TransitGatewayChanges = {
      pattern     = "{ ($.eventName = CreateTransitGateway) || ($.eventName = DeleteTransitGateway) || ($.eventName = ModifyTransitGateway) || ($.eventName = CreateTransitGatewayVpcAttachment) || ($.eventName = DeleteTransitGatewayVpcAttachment) || ($.eventName = ModifyTransitGatewayVpcAttachment) || ($.eventName = CreateTransitGatewayRoute) || ($.eventName = DeleteTransitGatewayRoute) || ($.eventName = ReplaceTransitGatewayRoute) || ($.eventName = CreateTransitGatewayRouteTable) || ($.eventName = DeleteTransitGatewayRouteTable) || ($.eventName = AssociateTransitGatewayRouteTable) || ($.eventName = DisassociateTransitGatewayRouteTable) || ($.eventName = EnableTransitGatewayRouteTablePropagation) || ($.eventName = DisableTransitGatewayRouteTablePropagation) }"
      description = "Monitoring changes to Transit Gateway will help ensure network segmentation and routing controls remain intact."
    }

    NatGatewayChanges = {
      pattern     = "{ ($.eventName = CreateNatGateway) || ($.eventName = DeleteNatGateway) }"
      description = "Monitoring NAT Gateway creation/deletion helps detect unexpected egress path changes."
    }
...
resource "aws_cloudwatch_metric_alarm" "this" {
  ...
  alarm_actions             = lookup(each.value, "alarm_actions", local.default_alarm_actions)
